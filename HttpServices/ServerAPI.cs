...
public class ServerAPI
{
    ...
    private static string host = "https://localhost:7287";

    /**
     * 
     */
    public static async Task<string> getContent(Methods methods,string endpoint, [Optional] Object todo)
    {
        ...
        switch (methods)
        {
            case Methods.Get:
                ...
                break;
            case Methods.Post:
                stringContent = new(JsonSerializer.Serialize(todo), Encoding.UTF8, "application/json");
